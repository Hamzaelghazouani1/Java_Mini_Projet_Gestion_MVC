...
import Controler.UpdateModifierEnt;
import Models.Entreprise;


public class ViewUpdateEntremprise extends JFrame  {
	...
	private UpdateModifierEnt controle = new UpdateModifierEnt(this);;

	
	
	public ViewUpdateEntremprise() {
	...
	public void setText(int id,String nom ,String Section) {
		 txtId.setText(id+"");
		 txtNom.setText(nom); 
		 txtlbSecteur.setText(Section);;
	}
