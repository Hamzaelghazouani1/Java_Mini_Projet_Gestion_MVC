...
import Controler.UpdateModifierserv;


public class ViewUpdateService extends JFrame  {
	...
	private UpdateModifierserv controle = new UpdateModifierserv(this);;
	...
	public ViewUpdateService() {
		...
		content.setLayout(null);
			...
			AjouterBtn(content);
			 ...
			 //->action de click  |>| UpdateModifierserv
	...
	public void setText(int id,int idEmp ,String nom ,int effectif) {
		txtId_service.setText(id+"");
		txtId_employer.setText(idEmp+""); 
		txtnom.setText(nom);
		txteffictif.setText(effectif+"");;
	}
	
	public Models.Service serv() {
		service.setId(Integer.parseInt(txtId_employer.getText()));
