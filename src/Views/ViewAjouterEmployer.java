...
import Controler.AddModifierEmp;
import Models.Employer;



public class ViewAjouterEmployer extends JFrame  {
	...
	private AddModifierEmp controle = new AddModifierEmp(this);;

	
	
	public ViewAjouterEmployer() {
		super("Employer ");
		...
		content.setLayout(null);
			...
			//->action de click  |>| AddModifierEmp
